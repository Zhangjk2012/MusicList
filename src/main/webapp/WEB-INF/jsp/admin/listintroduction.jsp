...
<body>
	<table id="listintroductionlist"></table>
	<div id="win" iconCls="icon-save" title="榜单信息">
        <form id="listintroductionform" action="admin/addlistintroduction" data-options="novalidate:true" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>榜单名称:</td>
                ...
                <tr>
                    <td colspan="4">
                        <textarea name="content" id="listintroductionContent" style="width:750px;height:500px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
        </form>
	...
	<div id="updateWin" iconCls="icon-edit" title="修改评委信息">
        <form id="updateform" action="admin/updatelistintroduction" data-options="novalidate:true" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>榜单名称:</td>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="4">
                        <textarea name="content" id="updatelistintroductionContent" style="width:750px;height:500px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
        </form>
...
<script type="text/javascript" src="js/listintroduction.js"></script>
</body>
</html>